...
## Project Structure
    ...
    ├── testgitconnector_de_39012  # Django project configurations
...
1. Clone this repo and `cd testgitconnector_de_39012`
...
2. Clone this repo and `cd testgitconnector_de_39012`
